...
public class CleanupProcessor {
	...
	private void initializeComponentSwimlaneConfiguration() throws Exception {
		...
		components.add(new SSKComponent("InitializeObjectDiff", "ssk146", "146 - Reports-as-a-Service Comparison - ObjectDiff", "REPORTS AS A SERVICE", "SSK146DataStructureBean"));
		components.add(new SSKComponent("HistoricDataMapBuilder", "ssk146", "146 - Reports-as-a-Service Comparison - ObjectDiff", "REPORTS AS A SERVICE", "SSK146MapBuilderBean"));
		components.add(new SSKComponent("ObjectDiff", "ssk146", "146 - Reports-as-a-Service Comparison - ObjectDiff", "REPORTS AS A SERVICE", "SSK146ObjectDiffBean"));
		components.add(new SSKComponent("InitializeReportDiff", "ssk149", "149 - Reports-as-a-Service Comparison - ReportDiff", "REPORTS AS A SERVICE", "SSK149DataStructureBean"));
		components.add(new SSKComponent("BuildUniqueIdList", "ssk149", "149 - Reports-as-a-Service Comparison - ReportDiff", "REPORTS AS A SERVICE", "SSK149ListBuilderBean"));
		components.add(new SSKComponent("ReportDiff", "ssk149", "149 - Reports-as-a-Service Comparison - ReportDiff", "REPORTS AS A SERVICE", "SSK149ReportDiffBean"));
		...
		components.add(new SSKComponent("SetExternalIntegrationHeaders", "ssk119", "119 - Workday Web Service (SOAP) External Integration Headers", "WORKDAY WEB SERVICES (WWS) API"));
		...
		components.add(new SSKComponent("GetAccessToken", "ssk160", "160 - Get Access Token", "WORKDAY WEB SERVICES (WWS) API"));
		components.add(new SSKComponent("CallRestApi", "ssk161", "161 - Call REST API", "WORKDAY WEB SERVICES (WWS) API"));
		components.add(new SSKComponent("WQL", "ssk162", "162 - WQL", "WORKDAY WEB SERVICES (WWS) API"));
		components.add(new SSKComponent("StoreExtendAttachment", "ssk163", "163 - Write Attachment Object", "WORKDAY WEB SERVICES (WWS) API"));
		...
		components.add(new SSKComponent("ExtendLogAggregationChain", "ssk134", "134 - Extend Log Aggregation Chain", "FILE UTILITIES"));
		components.add(new SSKComponent("GetLogAggregationChain", "ssk136", "136 - Get Log Aggregation Chain", "FILE UTILITIES"));
		components.add(new SSKComponent("HandleByteOrderMark", "ssk148", "148 - Byte Order Mark Utilities", "FILE UTILITIES", "SSK148ProcessorBean"));
		...
		components.add(new SSKComponent("Text2ParallelSplitter", "ssk117", "117 - Text to Parallel Splitter", "XSLT 3.0", "SSK117BlockSplitter"));
		components.add(new SSKComponent("GetXmlTransformer", "ssk117", "117 - Text to Parallel Splitter", "XSLT 3.0"));
		components.add(new SSKComponent("GetJsonTransformer", "ssk117", "117 - Text to Parallel Splitter", "XSLT 3.0"));
		components.add(new SSKComponent("GetContextPropertyTransformer", "ssk117", "117 - Text to Parallel Splitter", "XSLT 3.0"));
		components.add(new SSKComponent("XsltPlus", "ssk129", "129 - XSLT Transform", "XSLT 3.0"));
		components.add(new SSKComponent("MultiItemFlowControl", "ssk130", "130 - Multi-Item Flow Control", "XSLT 3.0"));
		components.add(new SSKComponent("GetRootOpenTag", "ssk135", "135 - Get Root Open Tag", "XSLT 3.0"));
		components.add(new SSKComponent("GetRootCloseTag", "ssk138", "138 - Get Root Close Tag", "XSLT 3.0"));
		components.add(new SSKComponent("StreamSourceMerge", "ssk153", "153 - Streaming Source Merge", "XSLT 3.0"));
		components.add(new SSKComponent("PrepareMergeSource", "ssk153", "153 - Streaming Source Merge", "XSLT 3.0"));
	}
