 ...
 * 	<li>Use the WS Tester to retrieve the integration configuration from the tenant.  A sample is provided in /ws/test/ssk/SSK_INTSYS__Get_Integration_Systems_Request.xml.  Use the Reference ID you noted above.</li>
 * 	<li>Copy and paste the response into /ws/test/StartHereTestCase_INTSYS.xml.</li>
 * 	<li>Use the WS Tester to retrieve the launch parameter data from the tenant.  A sample is provided in /ws/test/ssk/SSK_LP__Launch_Integration_Event_Request.xml.  Use the Reference ID you noted above.  If you've added launch parameters to your integration, you may have to add more elements to the request.  The AUnit Implementer's Guide on Community can help with this.</li>
...
public class StartHereTestCase extends UtilitiesTestCase {
	 ...
	 * /INT093_SEMA4_Out_SSK_Studio/ws/test/ssk/SSK_INTSYS_SOAP__Get_Integration_Systems_Request.xml, although you may need to update the
...
//	private static final String MOCK_INTEGRATION_SYSTEM = "test/StartHereTestCase_INTSYS.xml";
	 ...
	 * /INT093_SEMA4_Out_SSK_Studio/ws/test/ssk/SSK_LP_SOAP__Launch_Integration_Event_Request.xml, although you may need to update the
	 * wd:version of the request to match that of the WSDL for the service version being used.  Note that through use of the 
	 ...
	 *     <wd:ID wd:parent_id="INT093_SEMA4_Out_SSK_Studio_Collection/INT093_SEMA4_Out_SSK_Studio/StartHere" wd:parent_type="Integration_System_ID" wd:type="Launch_Parameter_Name">Your Parameter Name</wd:ID>
	 *   </wd:Launch_Parameter_Reference>
	 ...
	 * <wd:Integration_Launch_Parameter_Data>
	 *   <wd:Launch_Parameter_Reference>
	 *     <wd:ID wd:parent_id="INT093_SEMA4_Out_SSK_Studio_Collection/INT093_SEMA4_Out_SSK_Studio/StartHere" wd:parent_type="Integration_System_ID" wd:type="Launch_Parameter_Name">Cloud Log Output File Type</wd:ID>
	 *   </wd:Launch_Parameter_Reference>
	 *   <wd:Launch_Parameter_Value_Data>
	 *     <wd:Instance_Reference>
...
//	private static final String MOCK_INTEGRATION_EVENT = "test/StartHereTestCase_LP.xml";
	 ...
	 **************************************************************************************************************/
	/* (non-Javadoc)
	 * @see com.workday.custom.aunit.int093.CommonTestCase#extendedExitStateVerification(java.lang.Throwable)
	 */
	@Override
