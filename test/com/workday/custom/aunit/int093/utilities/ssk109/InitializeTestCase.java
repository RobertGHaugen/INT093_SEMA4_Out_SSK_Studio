package com.workday.custom.aunit.int093.utilities.ssk109;
...
public class InitializeTestCase extends CommonTestCase {
	public static final String MOCK_XML_INTSYS_COMPLETE_REST = "test/ssk/ssk109/SSK109_SOAP_Attr_Complete_WorkdayREST.xml";
	public static final String MOCK_XML_INTSYS_COMPLETE_EXTEND = "test/ssk/ssk109/SSK109_SOAP_Attr_Complete_WorkdayREST.xml";
	...
	public static final String MOCK_XML_INTSYS_PRIMARYLOG_AGG_SET = "test/ssk/ssk109/SSK109_SOAP_Attr_PrimaryLogAggregation.xml";
	public static final String MOCK_XML_INTSYS_SECONDARYLOG_AGG_SET = "test/ssk/ssk109/SSK109_SOAP_Attr_SecondaryLogAggregation.xml";
	...
	public static final String MOCK_XML_INTSYS_PRIMARYLOG_AGGTAG = "test/ssk/ssk109/SSK109_SOAP_Attr_NoPrimaryLogAggregationTag.xml";
	public static final String MOCK_XML_INTSYS_PRIMARYLOG_TABNAME = "test/ssk/ssk109/SSK109_SOAP_Attr_NoPrimaryLogTabName.xml";
	...
	public static final String MOCK_XML_INTSYS_SECONDARYLOG_AGGTAG = "test/ssk/ssk109/SSK109_SOAP_Attr_NoSecondaryLogAggregationTag.xml";
	public static final String MOCK_XML_INTSYS_SECONDARYLOG_TABNAME = "test/ssk/ssk109/SSK109_SOAP_Attr_NoSecondaryLogTabName.xml";
	
	public static final String MOCK_XML_INTSYS_SERVICE_CONFLICT_EXTEND_REST = "test/ssk/ssk109/SSK109_SOAP_Attr_Conflict-mutex-services_Extend_REST.xml";
	
	public static final String MOCK_XML_INTSYS_WORKDAYREST_CLIENT_ID = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayRESTClientID.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYREST_CLIENT_SECRET = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayRESTClientSecret.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYREST_REFRESH_TOKEN = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayRESTRefreshToken.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYREST_TOKEN_ENDPOINT = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayRESTTokenEndpoint.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYREST_API_ENDPOINT = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayRESTApiEndpoint.xml";

	public static final String MOCK_XML_INTSYS_WORKDAYEXTEND_CLIENT_ID = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayExtendClientID.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYEXTEND_CLIENT_SECRET = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayExtendClientSecret.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYEXTEND_TENANT_ALIAS = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayExtendTenantAlias.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYEXTEND_REFRESH_TOKEN = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayExtendRefreshToken.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYEXTEND_TOKEN_ENDPOINT = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayExtendTokenEndpoint.xml";
	public static final String MOCK_XML_INTSYS_WORKDAYEXTEND_GATEWAY_ENDPOINT = "test/ssk/ssk109/SSK109_SOAP_Attr_NoWorkdayExtendGatewayEndpoint.xml";
	...
	public void testFullConfigurationServiceMutexExtendREST() throws Exception {
		...
		errorDetails = "Both of the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' and 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' services are defined.  Workday REST functions in SSK only use one of these services - the other should be deleted from the Workday-In.  If you are not using Workday REST services at all, please delete both services.  If this integration is a part of a Workday Extend App, then keep the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service.  Otherwise, if not using Workday Extend, then keep the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service.";
	}
	...
	public void testNoPrimaryLogFilename() throws Exception { 
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the primary log.";
		errorDetails = "The 'Log File Name (Exclude File Extension)' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Primary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoPrimaryLogRetention() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the primary log.";
		errorDetails = "The 'Log Retention in Days' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Primary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoPrimaryLogMaxSize() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the primary log.";
		errorDetails = "The 'Max Entries per Log File' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Primary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoPrimaryLogFormat() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the primary log.";
		errorDetails = "The 'Cloud Log Output File Type' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Primary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoPrimaryLogAggregationTag() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the primary log.";
		errorDetails = "The 'Tag for Log Aggregator (overrides Cloud Log Output File Type)' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Primary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoPrimaryLogTabName() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the primary log.";
		errorDetails = "The 'Tab Name for Log Aggregator' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Primary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoSecondaryLogTabName() throws Exception {
		...
		errorDetails = "The 'Tab Name for Log Aggregator' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The service and its attributes are a core part of the SSK Framework and required for correct behavior.";
	}
	...
	public void testNoSecondaryLogFilename() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the secondary log.";
		errorDetails = "The 'Log File Name (Exclude File Extension)' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is in use.";
	}
	...
	public void testNoSecondaryLogRetention() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the secondary log.";
		errorDetails = "The 'Log Retention in Days' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is in use.";
	}
	...
	public void testNoSecondaryLogMaxSize() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the secondary log.";
		errorDetails = "The 'Max Entries per Log File' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is in use.";
	}
	...
	public void testNoSecondaryLogFormat() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the secondary log.";
		errorDetails = "The 'Cloud Log Output File Type' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is in use.";
	}
	...
	public void testNoSecondaryLogAggregationTag() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete configuration of the secondary log.";
		errorDetails = "The 'Tag for Log Aggregator (overrides Cloud Log Output File Type)' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Secondary Logging' service is in use.";
	}
	...
	public void testNoWorkdayRESTClientID() throws Exception {
		...
		errorDetails = "The 'API Client ID' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is in use.";
	}
	...
	public void testNoWorkdayRESTClientSecret() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'API Client Secret' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is in use.";
	}
	...
	public void testNoWorkdayRESTRefreshToken() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'Refresh Token' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is in use.";
	}
	...
	public void testNoWorkdayRESTTokenEndpoint() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'Token Endpoint' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is in use.";
	}
	...
	public void testNoWorkdayRESTApiEndpoint() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'API Endpoint' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday REST' service is in use.";
	}
	...
	public void testNoWorkdayExtendClientID() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'API Client ID' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is in use.";
   	}
	...
	public void testNoWorkdayExtendClientSecret() throws Exception {
		expectHandledException();
      	...
      	errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
      	errorDetails = "The 'API Client Secret' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is in use.";
	}
	...
	public void testNoWorkdayExtendTenantAlias() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'Tenant Alias' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is in use.";
	}
	...
	public void testNoWorkdayExtendTokenEndpoint() throws Exception {
		...
		errorMessage = "Custom step id=InitializeCoreSSK, ref=SSK109InitializeCore - Error while invoking bean, reason: Unable to complete Workday/Extend REST configuration.";
		errorDetails = "The 'Token Endpoint' on the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is required but appears to have been removed.  Please restore this attribute to the service on the Workday-In component.  The attribute is a core part of the SSK Framework and required for correct behavior when the 'INT093 SEMA4 Out SSK Studio - Attribute and Map Service - Workday Extend' service is in use.";
	}
