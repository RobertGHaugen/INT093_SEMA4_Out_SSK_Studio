...
import com.workday.custom.int093.ssk147.FlexLog;
import com.workday.custom.int093.ssk147.FlexLogBean;
import com.workday.custom.int093.ssk147.FlexLogField;
...
public class SSK109ConfigureFlexLogTestCase extends CommonTestCase {
	...
	public static final String VAR_SOURCE = "sskFlexLogConfiguration147";
	...
	public static final String PROP_PARAMETER_OUT_BEAN = "sskFlexLog";
	
	public static final String RESULT_CSV_FRESH_LOG = "test/ssk/ssk147/SSK147_FreshLog.csv";
	public static final String MOCK_XML_COMPLEX_CONFIG = "test/ssk/ssk147/SSK147_Configuration_IsolatedAttributes.xml";
	public static final String MOCK_XML_EMPTY_CONFIG = "test/ssk/ssk147/SSK147_Configuration_NoLogs.xml";
	public static final String MOCK_XML_ONE_CONFIG = "test/ssk/ssk147/SSK147_Configuration_OneLog.xml";
	public static final String MOCK_XML_TWO_CONFIG = "test/ssk/ssk147/SSK147_Configuration_TwoLogs.xml";
	public static final String MOCK_XML_DUPLICATE_CONFIG = "test/ssk/ssk147/SSK147_Configuration_DuplicateLogs.xml";
	public static final String MOCK_XML_NOT_CONFIG = "test/ssk/ssk147/SSK147_XML_NotConfiguration.xml";
	public static final String MOCK_XSD = "test/ssk/ssk147/SSK147_FlexLogs.xsd";
	public static final String MOCK_NOT_FOUND_CONFIG = "test/ssk/ssk147/SSK147_ThisFileDoesNotExist.xml";
	...
	protected void extendedExitStateVerification(Throwable t) throws Exception {
		if (!testsExpectingUnhandledExceptions.contains(getName())) {
			...
			if (getName().contains("Complex")) {
				...
				sskFlexLog = (FlexLogBean)bean;

				for (int i = 1; i <= 6; i++) {
					FlexLog log = sskFlexLog.getFlexLog("log" + i); 
				...
				FlexLog log = sskFlexLog.getFlexLog(VAR_FLEX_LOG);
				...
				FlexLog log = sskFlexLog.getFlexLog(VAR_LOG1);
				...
				log = sskFlexLog.getFlexLog(VAR_FLEX_LOG);
