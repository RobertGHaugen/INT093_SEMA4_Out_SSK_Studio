package com.workday.custom.aunit.int093.utilities.ssk142;
...
public class CreateLogEntryTestCase extends CommonTestCase {
	...
	@AssertAfter(id="UpdatePrimaryLogTracking_142")
	...
	@AssertAfter(id="PrimaryLog_HTML_142")
	public void verifyLoggedMessageHTML() throws Exception {
		if ("testHtmlCriticalMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryHTML("CRITICAL", "Critical Message", "Critical Message Detail", "101", "testCriticalMessage", "10000", "1", "Details about 10000");
			...
			assertPrimaryCloudLogEntryHTML("INFO", "Info Message", "Info Message Detail", "101", "testInfoMessage", null, "4", null);
		} else if ("testHtmlDebugMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryHTML("DEBUG", "Debug Message", "Debug Message Detail", "101", "testDebugMessage", null, "5", "Deep technical details supporting debugging");
		} else if ("testHtmlInfoMessageMinimal".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryHTML("INFO", "Info Message", "Minimum Detail", null, null, null, null, null);
		}
	}
	
	@AssertAfter(id="PrimaryLog_CSV_142")
	public void verifyLoggedMessageCSV() throws Exception {
		if ("testCsvCriticalMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("CRITICAL", "Critical Message", "Critical Message Detail", "101", "testCriticalMessage", "10000", "1", "Details about 10000");
		} else if ("testCsvErrorMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("ERROR", "Error Message", "Error Message Detail", "101", "testErrorMessage", "10001", "2", "Details about 10001");
		} else if ("testCsvWarnMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("WARN", "Warn Message", "Warn Message, Detail", "101", "testWarnMessage", "10002", "3", "Details about 10002");
		} else if ("testCsvInfoMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("INFO", "Info Message", "Info Message with \"Detail\"", "101", "testInfoMessage", null, "4", null);
		} else if ("testCsvDebugMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("DEBUG", "Debug Message", "Debug Message, \"Detail\"", "101", "testDebugMessage", null, "5", "Deep technical details supporting debugging");
		} else if ("testCsvInfoMessageMinimal".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("INFO", "Info Message", "Minimum Detail", null, null, null, null, null);
		}
	}
