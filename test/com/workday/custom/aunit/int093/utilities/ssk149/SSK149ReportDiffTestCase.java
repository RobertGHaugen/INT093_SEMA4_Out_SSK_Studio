package com.workday.custom.aunit.int093.utilities.ssk149;
...
public class SSK149ReportDiffTestCase extends UtilitiesTestCase {
	...
	public static final String MOCK_XML_DATA_HISTORIC = "test/ssk/ssk149/SSK149_Positions_Historic.xml";
	public static final String MOCK_XML_DATA_CURRENT = "test/ssk/ssk149/SSK149_Positions_Current.xml";
	public static final String MOCK_XML_DATA_RESULT_DELTA = "test/ssk/ssk149/SSK149_Positions_DiffResult_DeltaFile.xml";
	public static final String MOCK_XML_DATA_RESULT_FULL = "test/ssk/ssk149/SSK149_Positions_DiffResult_FullFile.xml";

	public static final String MOCK_XML_DATA_NESTED_MULTI_HISTORIC = "test/ssk/ssk149/SSK149_NestedMultiValue_Historic.xml";
	public static final String MOCK_XML_DATA_NESTED_MULTI_CURRENT = "test/ssk/ssk149/SSK149_NestedMultiValue_Current.xml";
	public static final String MOCK_XML_RESULT_NESTED_MULTI_DELTA = "test/ssk/ssk149/SSK149_NestedMultiValue_DiffResult_DeltaFile.xml";
	public static final String MOCK_XML_RESULT_NESTED_MULTI_FULL = "test/ssk/ssk149/SSK149_NestedMultiValue_DiffResult_FullFile.xml";

	public static final String MOCK_XML_DATA_NESTED_CARDINALITY_HISTORIC = "test/ssk/ssk149/SSK149_MultiInstanceVsReference_Historic_SingleRelated.xml";
	public static final String MOCK_XML_DATA_NESTED_CARDINALITY_CURRENT = "test/ssk/ssk149/SSK149_MultiInstanceVsReference_Current_MultipleRelated.xml";
	public static final String MOCK_XML_RESULT_NESTED_CARDINALITY_FULL = "test/ssk/ssk149/SSK149_MultiInstanceVsReference_DiffResult_FullFile.xml";
	
	public static final String MOCK_XML_DATA_NESTED_CHANGESONLY_HISTORIC = "test/ssk/ssk149/SSK149_FalsePositiveMultiInstance_Historic.xml";
	public static final String MOCK_XML_DATA_NESTED_CHANGESONLY_HISTORIC_SINGLE = "test/ssk/ssk149/SSK149_FalsePositiveMultiInstance_HistoricSingleRecord.xml";
	public static final String MOCK_XML_DATA_NESTED_CHANGESONLY_CURRENT = "test/ssk/ssk149/SSK149_FalsePositiveMultiInstance_Current.xml";
	public static final String MOCK_XML_RESULT_NESTED_CHANGESONLY_DELTA = "test/ssk/ssk149/SSK149_FalsePositiveMultiInstance_DeltaFile.xml";
	public static final String MOCK_XML_RESULT_NESTED_CHANGESONLY_DELTA_SINGLE = "test/ssk/ssk149/SSK149_FalsePositiveMultiInstance_DeltaFileSingleRecord.xml";
