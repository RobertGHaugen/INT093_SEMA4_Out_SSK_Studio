package com.workday.custom.aunit.int093.utilities.ssk163;
...
public class SSKComponent163TestCase extends UtilitiesTestCase {
    ...
    public static final String MOCK_POST_BODY_PDF = "test/ssk/ssk163/SSK163_Body_PDF.json";
    public static final String MOCK_POST_BODY_PNG = "test/ssk/ssk163/SSK163_Body_PNG.json";

    public static final String MOCK_FILE_PDF = "test/ssk/ssk163/file.pdf";
    public static final String MOCK_FILE_PNG = "test/ssk/ssk163/file.png";

    public static final String MOCK_RESPONSE_POST_PDF = "test/ssk/ssk163/SSK163_Response_PDF.json";
    public static final String MOCK_RESPONSE_POST_PNG = "test/ssk/ssk163/SSK163_Response_PNG.json";
	public static final String MOCK_RESPONSE_BAD_REQUEST_EXCEPTION = "test/ssk/ssk163/SSK163_Response_BadRequestException.json";
