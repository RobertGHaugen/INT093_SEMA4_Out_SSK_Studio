package com.workday.custom.aunit.int093.utilities.ssk151;
...
public class SSKComponent151TestCase extends UtilitiesTestCase {
    ...
    public static final String VAR_LOCAL_SYSTEM_CACHE = "ssk151-98ee329f630d011af0a0c85ab0470000";
    ...
    public static final String VALUE_SERVICE_CSV = "INT093 SEMA4 Out SSK Studio Attachment Service - CSV";
    public static final String VALUE_SERVICE_JSN = "INT093 SEMA4 Out SSK Studio Attachment Service - JSON";
    public static final String VALUE_SERVICE_PDF = "INT093 SEMA4 Out SSK Studio Attachment Service - PDF";
    public static final String VALUE_SERVICE_PNG = "INT093 SEMA4 Out SSK Studio Attachment Service - PNG";
    public static final String VALUE_SERVICE_XML = "INT093 SEMA4 Out SSK Studio Attachment Service - XML";

    public static final String MOCK_INT_SYS_RESPONSE = "test/ssk/ssk151/SSK151_Get_Integration_System_Response.xml";
	public static final String MOCK_FILE_CSV = "test/ssk/ssk151/file.csv";
	public static final String MOCK_FILE_JSN = "test/ssk/ssk151/json.txt";
	public static final String MOCK_FILE_PDF = "test/ssk/ssk151/file.pdf";
    public static final String MOCK_FILE_PNG = "test/ssk/ssk151/file.png";
    public static final String MOCK_FILE_XML = "test/ssk/ssk151/file.xml";
