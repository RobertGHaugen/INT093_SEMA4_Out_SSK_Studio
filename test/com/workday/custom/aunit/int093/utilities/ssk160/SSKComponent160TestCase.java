package com.workday.custom.aunit.int093.utilities.ssk160;
...
public class SSKComponent160TestCase extends UtilitiesTestCase {
    ...
    public static final String MOCK_RESPONSE_TENANT_REFRESH_TOKEN = "test/ssk/ssk160/SSK160_TENANT_RefreshToken_TokenEndpoint_Response.json";
    public static final String MOCK_RESPONSE_EXTEND_CLIENT_CREDENTIALS = "test/ssk/ssk160/SSK160_EXTEND_ClientCredentials_TokenEndpoint_Response.json";
	public static final String MOCK_RESPONSE_EXTEND_REFRESH_TOKEN = "test/ssk/ssk160/SSK160_EXTEND_RefreshToken_TokenEndpoint_Response.json";

	public static final String MOCK_RESULT_TENANT_PRE_ENCODED_AUTH = "test/ssk/ssk160/SSK160_TENANT_PreEncodedAuth.txt";
	public static final String MOCK_RESULT_EXTEND_PRE_ENCODED_AUTH = "test/ssk/ssk160/SSK160_EXTEND_PreEncodedAuth.txt";

	public static final String MOCK_RESULT_TENANT_ENCODED_AUTH = "test/ssk/ssk160/SSK160_TENANT_EncodedAuth.txt";
	public static final String MOCK_RESULT_EXTEND_ENCODED_AUTH = "test/ssk/ssk160/SSK160_EXTEND_EncodedAuth.txt";

	public static final String MOCK_RESULT_TENANT_BODY_REFRESH_TOKEN = "test/ssk/ssk160/SSK160_TENANT_Body_RefreshToken.txt";
	public static final String MOCK_RESULT_EXTEND_BODY_REFRESH_TOKEN = "test/ssk/ssk160/SSK160_EXTEND_Body_RefreshToken.txt";
	public static final String MOCK_RESULT_EXTEND_BODY_CLIENT_CREDENTIALS = "test/ssk/ssk160/SSK160_EXTEND_Body_ClientCredentials.txt";

	public static final String MOCK_RESULT_BAD_REQUEST_EXCEPTION = "test/ssk/ssk160/SSK160_HttpResponse_BadRequestException.json";
