package com.workday.custom.aunit.int093.utilities.ssk161;
...
public class SSKComponent161TestCase extends UtilitiesTestCase {
    ...
    public static final String MOCK_POST_BODY = "test/ssk/ssk161/SSK161_POST_Body.json";
    public static final String MOCK_RESPONSE_POST_JSON = "test/ssk/ssk161/SSK161_POST_Response.json";
    public static final String MOCK_RESULT_POST_XML = "test/ssk/ssk161/SSK161_POST_Response.xml";

	public static final String MOCK_RESPONSE_BAD_REQUEST_EXCEPTION = "test/ssk/ssk161/SSK161_HttpResponse_BadRequestException.json";
	public static final String MOCK_RESPONSE_NONE_JSON = "test/ssk/ssk161/SSK161_GET_NoResults.json";
	public static final String MOCK_RESULT_NONE_XML = "test/ssk/ssk161/SSK161_GET_NoResults.xml";
	public static final String MOCK_RESPONSE_NONE_PAGINATED_JSON = "test/ssk/ssk161/SSK161_GET_NoResults_Paginated.json";
	public static final String MOCK_RESULT_NONE_PAGINATED_JSON = "test/ssk/ssk161/SSK161_GET_NoResults_Paginated-return.json";
	public static final String MOCK_RESULT_NONE_PAGINATED_XML = "test/ssk/ssk161/SSK161_GET_NoResults_Paginated.xml";
	public static final String MOCK_RESPONSE_SINGLE_JSON = "test/ssk/ssk161/SSK161_GET_Result.json";
	public static final String MOCK_RESULT_SINGLE_XML = "test/ssk/ssk161/SSK161_GET_Result.xml";
	public static final String MOCK_RESPONSE_ALL_JSON = "test/ssk/ssk161/SSK161_GET_AllResults.json";
	public static final String MOCK_RESPONSE_PAGE0_JSON = "test/ssk/ssk161/SSK161_GET_ResultPage-0.json";
	public static final String MOCK_RESULT_PAGE0_JSON = "test/ssk/ssk161/SSK161_GET_ResultPage-0-return.json";
	public static final String MOCK_RESULT_PAGE0_XML = "test/ssk/ssk161/SSK161_GET_ResultPage-0-return.xml";
	public static final String MOCK_RESPONSE_PAGE1_JSON = "test/ssk/ssk161/SSK161_GET_ResultPage-1.json";
	public static final String MOCK_RESPONSE_PAGE2_JSON = "test/ssk/ssk161/SSK161_GET_ResultPage-2.json";
	public static final String MOCK_RESPONSE_PAGE3_JSON = "test/ssk/ssk161/SSK161_GET_ResultPage-3.json";
	public static final String MOCK_RESULT_AGGREGATED_JSON = "test/ssk/ssk161/SSK161_GET_AllResults_Aggregated.json";
	public static final String MOCK_RESULT_AGGREGATED_XML = "test/ssk/ssk161/SSK161_GET_AllResults_Aggregated.xml";
