...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    CR_INT093 SEMA4 Period Activity Assignments Job Record Number Terms Report ID: var.peractterms.report
    CR_INT093 SEMA4 Disbursement Plan 9                                 Report ID: var.9monthfaculty.report
    ...
    <xsl:template match="Results">
        <HEADER>&#34;POSITION_NBR&#34;,&#34;WORKER&#34;,&#34;EFFDT&#34;,&#34;ACTION&#34;,&#34;ACTION_COMPLETED&#34;,&#34;ACTION_DT&#34;,&#34;ACTION_REASON&#34;,&#34;JOB_RECORD_NUMBER&#34;,&#34;PERIOD_ACTIVITY_START_DATE&#34;,&#34;PERIOD_ACTIVITY_END_DATE&#34;,&#34;ACTIVITY_TYPE&#34;,&#34;REPORT_ID&#34;</HEADER>
    ...
    <xsl:template match="wd:Report_Data/wd:Report_Entry[
        ...
        or (wd:REPORT_ID = 'var.peractterms.report')
        or (wd:REPORT_ID = 'var.9monthfaculty.report')
        ...
        <Delimiter><xsl:value-of select="$vDelimiter"/></Delimiter>
        <Period_Activity_Start_Date>
            <xsl:value-of select="wd:Period_Activity_Start_Date"/>
        </Period_Activity_Start_Date>
        <Delimiter><xsl:value-of select="$vDelimiter"/></Delimiter>
        <Period_Activity_End_Date>
            <xsl:value-of select="wd:Period_Activity_End_Date"/>
        </Period_Activity_End_Date>
        <Delimiter><xsl:value-of select="$vDelimiter"/></Delimiter>
        <Activity_Type>
            <xsl:value-of select="wd:Activity_Type"/>
        </Activity_Type>
        <Delimiter><xsl:value-of select="$vDelimiter"/></Delimiter>
        <REPORT_ID>
