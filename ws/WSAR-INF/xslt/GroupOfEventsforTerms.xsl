    ...
    <xsl:template match="wd:Report_Data">
        ...
        <wd:Report_Data>
            ...
            <xsl:for-each-group select="wd:Report_Entry[exists(wd:WORKER)]"
                group-by="concat(wd:POSITION_NBR,wd:WORKER,wd:EFFDT,wd:Termination_Event_group/wd:ACTION_REASON,wd:ACTION_COMPLETED)">
                ...
                <wd:Report_Entry>
                    ...
                    <wd:ACTION>
                        <xsl:value-of select="substring-before(substring-after(wd:Termination_Event_group/wd:ACTION_REASON/wd:ID[@wd:type='Local_Termination_Reason_ID'],'_'),'_')"/>
                    </wd:ACTION>
                    <wd:ACTION_COMPLETED>
                        <xsl:value-of
