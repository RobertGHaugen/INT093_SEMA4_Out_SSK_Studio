<xsl:stylesheet 
    ...
    exclude-result-prefixes="xsd tube ctx ssk"
    version="3.0">
    ...
    <!--
    <xsl:param name="sskXsltLibMessage" as="xsd:string" select="ctx:getProperty(tube:getCurrentMediationContext(),'sskXsltLibMessage')" static="yes"/>
	...
	-->
    <xsl:param name="sskXsltLibMessage" as="xsd:string" select="'file:/C:/Users/john.smail/workspace/ConfigCatalog/INT093_SEMA4_Out_SSK_Studio/ws/WSAR-INF/xslt/ssk112/SSK112_FunctionLib_Messages.xsl'" static="yes"/>
    ...
    <xsl:template match="wd:Import_Ad_hoc_Bank_Transaction_Request">
        ...
        <wd:Messages>
            ...
            <xsl:message select="ssk:createMessage(
                'info', 
