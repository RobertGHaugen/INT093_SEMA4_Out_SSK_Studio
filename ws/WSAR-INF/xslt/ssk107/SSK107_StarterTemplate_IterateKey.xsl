...
<xsl:stylesheet
    ...
    <xsl:param name="sskXsltLibMessage" as="xsd:string" select="'file:/C:/Users/john.smail/workspace/YourWorkspaceFolder/YourAssemblyProjectFolder/ws/WSAR-INF/xslt/ssk112/SSK112_FunctionLib_Messages.xsl'" static="yes"/>
	-->
