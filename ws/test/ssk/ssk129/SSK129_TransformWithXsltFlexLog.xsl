...
<xsl:stylesheet 
    ...
    <!--
    <xsl:param name="sskXsltLibFlexLogMessages" as="xs:string" select="ctx:getProperty(tube:getCurrentMediationContext(),'sskXsltLibFlexLogMessages')" static="yes"/>
	...
	-->
    <xsl:param name="sskXsltLibFlexLogMessages" as="xs:string" select="'file:/C:/Users/john.smail/workspace/ConfigCatalog/INT093_SEMA4_Out_SSK_Studio/ws/WSAR-INF/xslt/ssk147/SSK147_FunctionLib_Messages.xsl'" static="yes"/>
    ...
    -->
    <xsl:include _href="{$sskXsltLibFlexLogMessages}"/>
