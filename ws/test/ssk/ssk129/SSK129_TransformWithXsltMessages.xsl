...
<xsl:stylesheet 
	...
	-->
    <!-- <xsl:param name="sskXsltLibMessage" as="xs:string" select="'file:/C:/Users/john.smail/workspace/ConfigCatalog/INT093_SEMA4_Out_SSK_Studio/ws/WSAR-INF/xslt/ssk112/SSK112_FunctionLib_Messages.xsl'" static="yes"/> -->
